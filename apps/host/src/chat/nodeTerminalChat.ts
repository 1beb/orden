...
// pane, exactly like plan-annotation delivery does. `answerQuestion` drives
// claude's interactive AskUserQuestion menu by sending the keystrokes the chat
// UI's answer implies (see questionKeystrokes).
